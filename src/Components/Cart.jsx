...
import { getCart, removeFromCart, updateQuantity } from '../Tools/cartUtils.js'
...
const Cart = () => {
  ...
  const total = cartItems.reduce((s, it) => s + (it.price || 0) * (it.quantity || 1), 0);
  return (
    <>
...
<Link to={'/checkout'}><div className='w-full h-[40px] bg-gray-500 py-1 text-center content-center font-bold text-xl rounded-2xl hover:bg-blue-500 active:scale-[1.1]'>
    Check Out
    </div></Link>
